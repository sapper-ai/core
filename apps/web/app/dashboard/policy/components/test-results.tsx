...
export function TestResults({ result }: { result: AdversaryCampaignResponse }) {
  return (
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="grid gap-2">
            <p className="text-xs font-semibold uppercase tracking-wider text-steel">Test Results</p>
      ...
      <div className="grid gap-2">
        ...
        <ul className="grid gap-1.5">
          {result.topReasons.length === 0 ? (
            <li className="rounded-lg border border-border bg-muted px-3 py-2 text-xs text-steel">No reasons</li>
          ) : (
